...
if [ "$1" = "train" ]; then
    ...
    CUDA_VISIBLE_DEVICES=0,1,2,3 python run.py decode mathqa-trained/model6layer.bin ./mathqa/tq.txt ./mathqa/ta.txt outputs/mathqa-test_outputs6layer.txt --cuda
elif [ "$1" = "train_local" ]; then
