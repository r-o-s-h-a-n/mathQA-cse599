...
# if [ "$1" = "train" ]; then
# 	CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python run.py train --train-src=./mathqa/q.txt --train-tgt=./mathqa/a.txt --dev-src=./mathqa/dq.txt --dev-tgt=./mathqa/da.txt --vocab=mathqa-vocab.json --cuda
# elif [ "$1" = "test" ]; then
#     CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python run.py decode mathqa-trained/model4.bin ./mathqa/tq.txt ./mathqa/ta.txt outputs/mathqa-test_outputs4.txt --cuda
# elif [ "$1" = "train_local" ]; then
...
#     python run.py decode model.bin ./en_es_data/test.es ./en_es_data/test.en outputs/test_outputs.txt
# elif [ "$1" = "vocab" ]; then
# 	python vocab.py --train-src=./mathqa/q.txt --train-tgt=./mathqa/a.txt mathqa-vocab-word-word.json
# else
# 	echo "Invalid Option Selected"
# fi
...
if [ "$1" = "train" ]; then
	CUDA_VISIBLE_DEVICES=0,1,2,3 python run.py train --train-src=./mathqa/q.txt --train-tgt=./mathqa/a.txt --dev-src=./mathqa/dq.txt --dev-tgt=./mathqa/da.txt --vocab=mathqa-vocab-word-word.json --cuda
elif [ "$1" = "test" ]; then
    ...
    python run.py train --train-src=./mathqa/q.txt --train-tgt=./mathqa/a.txt --dev-src=./mathqa/dq.txt --dev-tgt=./mathqa/da.txt --vocab=mathqa-vocab-word-word.json
elif [ "$1" = "test_local" ]; then
